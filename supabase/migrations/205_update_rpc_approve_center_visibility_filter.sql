-- ============================================================
-- UPDATE RPC: get_approval_center_data
-- Add visibility filtering for day-off requests
-- Filters day_off requests based on approver visibility scope
-- ============================================================

CREATE OR REPLACE FUNCTION get_approval_center_data(p_user_id UUID)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
