<script lang="ts">
	...
	async function uploadImage(categoryId: string): Promise<string | null> {
	...
	async function handleSave() {
		...
		try {
			...
			if (categoryImage && newCategory) {
				imageUrl = await uploadImage(newCategory.id);
			...
			uploadError = error.message || 'Failed to save category';
...
<div class="category-form-container">
	...
	<div class="form-content">
		<div class="form-group">
			<label for="category-name-en">Category Name (English)</label>
			<input
				id="category-name-en"
				type="text"
		...
		<div class="form-group">
			<label for="category-name-ar">Category Name (Arabic)</label>
			<input
				id="category-name-ar"
				type="text"
